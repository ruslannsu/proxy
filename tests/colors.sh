...
## Example: echo -e "${On_IGre}${UYel}Hello ${Red}world!${RCol}"

# Show colors only if connected to terminal
if [ -t 1 ]; then
	ESeq="\e["
	...
	# Regular               Bold                    Underline               High Intensity          Bold High Intensity     Background              High Intensity Background
